...
<html>
	<head>
    	...
    	<link rel="stylesheet" href="/css/hero3.css?v=4"> 
	</head>
	<body>
              		     	...
              		     	<div class="carousel-item <?php echo $active == false ? 'active' : ''; ?>">
                                <?php if($i == 0) {?>
                     				<div class="d-block w-100" 
                     				     style="background: url('/multimedia/<?php echo $monumento['foto_oficial']; ?>'); height: 100%;">
                     				</div>
                                <?php } else {?>
                                    <div class="d-block w-100" 
                                         style="background: url('/multimedia/<?php echo $row['direccion_archivo']; ?>'); height: 100%;">
                                    </div>                                
                 				<?php }
